...
class Logger(object):
    ...
    Examples::
       ...
       >>> import os
       >>> import os.path as osp
       >>> from library.Detector.Yolov5_DeepSort_Pytorch.deep_sort.deep.reid.torchreid.utils import Logger
...
class RankLogger(object):
    ...
    Examples::
        >>> from library.Detector.Yolov5_DeepSort_Pytorch.deep_sort.deep.reid.torchreid.utils import RankLogger
        >>> s = 'market1501'
        >>> t = 'market1501'
