...
def _create(name, pretrained=True, channels=3, classes=80, autoshape=True, verbose=True, device=None):
    ...
    from library.Detector.Yolov5_DeepSort_Pytorch.yolov5.models.common import AutoShape, DetectMultiBackend
    ...
    from library.Detector.Yolov5_DeepSort_Pytorch.yolov5.utils.general import LOGGER, check_requirements, intersect_dicts, logging
